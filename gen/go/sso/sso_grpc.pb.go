...
func (c *authClient) CheckRegisterCode(ctx context.Context, in *CheckRegisterCodeRequest, opts ...grpc.CallOption) (*CheckRegisterCodeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckRegisterCodeResponse)
	err := c.cc.Invoke(ctx, Auth_CheckRegisterCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) SendRegisterCode(ctx context.Context, in *SendRegisterCodeRequest, opts ...grpc.CallOption) (*SendRegisterCodeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendRegisterCodeResponse)
	err := c.cc.Invoke(ctx, Auth_SendRegisterCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServer) CheckRegisterCode(context.Context, *CheckRegisterCodeRequest) (*CheckRegisterCodeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckRegisterCode not implemented")
}
func (UnimplementedAuthServer) SendRegisterCode(context.Context, *SendRegisterCodeRequest) (*SendRegisterCodeResponse, error) {
...
func _Auth_CheckRegisterCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckRegisterCodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).CheckRegisterCode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_CheckRegisterCode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).CheckRegisterCode(ctx, req.(*CheckRegisterCodeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Auth_SendRegisterCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendRegisterCodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).SendRegisterCode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_SendRegisterCode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).SendRegisterCode(ctx, req.(*SendRegisterCodeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CheckRegisterCode",
			Handler:    _Auth_CheckRegisterCode_Handler,
		},
		{
			MethodName: "SendRegisterCode",
			Handler:    _Auth_SendRegisterCode_Handler,
		},
		{
			MethodName: "Login",
